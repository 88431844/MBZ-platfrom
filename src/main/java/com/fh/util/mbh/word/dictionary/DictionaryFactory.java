...
package com.fh.util.mbh.word.dictionary;
...
import com.fh.util.mbh.word.dictionary.impl.DictionaryTrie;
import com.fh.util.mbh.word.recognition.PersonName;
import com.fh.util.mbh.word.util.AutoDetector;
import com.fh.util.mbh.word.util.ResourceLoader;
...
public final class DictionaryFactory {
    ...
    private static final class DictionaryHolder{
        ...
        private static Dictionary constructDictionary(){  
            try{
                ...
                String dicClass = WordConfTools.get("dic.class", "com.fh.util.mbh.word.dictionary.impl.TrieV4");
    ...
    private static void test(String dicClass) throws Exception{
        ...
        Stream<String> words = Files.lines(Paths.get("src/main/resources/dic.txt"));
        System.gc();
        Thread.sleep(60000);
        long start = System.currentTimeMillis();
        for(int i=0; i<100; i++){
