...
package com.fh.util.mbh.word.segmentation.impl;
...
import com.fh.util.mbh.word.corpus.Bigram;
import com.fh.util.mbh.word.corpus.Trigram;
import com.fh.util.mbh.word.dictionary.Dictionary;
import com.fh.util.mbh.word.dictionary.DictionaryFactory;
import com.fh.util.mbh.word.recognition.PersonName;
import com.fh.util.mbh.word.recognition.Punctuation;
import com.fh.util.mbh.word.segmentation.DictionaryBasedSegmentation;
import com.fh.util.mbh.word.segmentation.Segmentation;
import com.fh.util.mbh.word.segmentation.SegmentationAlgorithm;
import com.fh.util.mbh.word.segmentation.Word;
import com.fh.util.mbh.word.segmentation.WordRefiner;
import com.fh.util.mbh.word.util.WordConfTools;
