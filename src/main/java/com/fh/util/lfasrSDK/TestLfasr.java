...
//
//	// 原始音频存放地址
////	private static final String local_file = "E:\\jsonTest\\2018-06-01-00-23-38-a6cbaff0240a49cd8c04e5f1cc21514b-ch_ch.mp3";
//	/*
//	 * 转写类型选择：标准版和电话版分别为：
...
//	
//	public static String getLfasrVale(String local_file,String task_id){
//		String lfasrValueJson = null;
//		
//		// 加载配置文件
//			PropertyConfigurator.configure("src/main/resources/log4jForlfasr.properties");
//			
//			// 初始化LFASR实例
...
//					//把结果放到list中
//					lfasrValueJson = resultMsg.getData();
//				} else {
//					// 转写失败，根据失败信息进行处理
...
//				System.out.println("failed=" + resultMsg.getFailed());
//			}
//		return lfasrValueJson;
//	}
//	
//	public static void main(String[] args) {
//		// 原始音频存放地址
//		String local_file = "E:\\jsonTest\\2018-06-01-00-23-38-a6cbaff0240a49cd8c04e5f1cc21514b-ch_ch.mp3";
//		// 加载配置文件
//		PropertyConfigurator.configure("src/main/resources/log4jForlfasr.properties");
//		
//		// 初始化LFASR实例
